    ...
    <div class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between h-16 items-center">
                    ...
                    <div class="flex items-center flex-1 max-w-xl ml-8">
                        <div class="w-full relative">
                            <a-input-search v-model="searchText" placeholder="搜索影视剧..." class="!rounded-button"
                                allow-clear search-button @search="handleSearchByPage">
            ...
            <div class="border-b">
                <div class="max-w-7xl mx-auto px-4">
                    <div class="flex space-x-8">
                        <a-tabs type="rounded" @tab-click="handleSearchByPage" v-model:activeKey="pageConfig.type">
                            <a-tab-pane v-for="nav in navigation" :key="nav.type" :title="nav.name" />
                        </a-tabs>
                    </div>
                </div>
            </div>
        ...
        <main class="pt-32 pb-12 max-w-7xl mx-auto px-4">
            ...
            <a-spin :loadin="loading" tip="查询中..." class="w-full">
                        ...
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                ...
                                <div class="mt-2 flex items-center">
                                    ...
                                    <div class="flex ">
                                        <a-tag color="blue">{{ movie.type ? MOVIES_TYPE[Number(movie.type)] : '短剧'
                                            }}</a-tag>
                                    </div>
                                </div>
                                <p class="mt-2 text-gray-600">{{ movie.description }}</p>
                            </div>
                            <a-button type="primary" class="!rounded-button whitespace-nowrap"
                                @click="handleGoTo(movie)">
                                立即观看
                            </a-button>
                        </div>
                    </div>
                ...
                <!-- 底部 -->
                <footer
                    class="h-16 flex flex-col items-center justify-center text-sm text-center text-gray-600 font-bold">
