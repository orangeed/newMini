  ...
  <div class="min-h-screen bg-gray-50">
    <a-spin :loading="loading" tip="加载中..." class="w-full h-screen">
      ...
      <header class="lg:hidden fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
        ...
        <!-- Mobile Menu Overlay -->
        <div v-if="mobileMenuOpen" class="fixed inset-0 bg-black bg-opacity-50 z-50 transition-opacity duration-600"
          :class="{ 'bg-opacity-50': mobileMenuOpen }" @click="mobileMenuOpen = false">
        </div>
        <!-- Mobile Menu -->
        <div
          class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50 transform transition-all duration-600 ease-in-out-smooth"
